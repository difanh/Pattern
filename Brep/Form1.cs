    ...
    public partial class Form1 : Form
    {
       ...
       // private SimpleLogger _logger = new SimpleLogger();
        ...
        private void EigenDecomp(List<EigenDecomp> EigenList)
        {
            ...
            float D;
               ...
               using (System.IO.StreamWriter file = new System.IO.StreamWriter(exePath, true))
               {
                   ...
                   T = EigenList[0].m11 * EigenList[0].m22;
                   file.WriteLine(EigenList[0].m11.ToString());
        ...
        private void SRFtoMesh()
        {
            ...
            // -f can be cheap for background mesh in Ved's COde
              //  strCmdText = "/C volmesh --BUB --PBUB -infile output.srf -out meshd.srm -autoboundary -tfd  U" + bsize + " -e 100 -f 400";

                strCmdText = "/C volmesh --BUB --PBUB -infile output.srf -out meshd.srf -tfd U0.5 -e 1200 -f 480";
                Console.WriteLine(strCmdText);
                Thread.Sleep(new TimeSpan(0, 0, 1));
                System.Diagnostics.Process.Start("CMD.exe", strCmdText);
       ...
       private void ReadSRF()
        ...
        private void PurgeCommand()
        {
            ...
            strCmdText = "/C del input.stl *.srf";
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            strCmdText = "/C tensorcli.exe --geom meshd.srf --disablepadbgmesh --bgmesh __ " // __ means mesh.srf
             + "--insertbc " + " 33 -8  2.0 1.0 0.0  1.15  "
             + "--insertbc " + " 35 -8  3.0 1.0 0.0  1.05  "
             + "--insertbc " + " 38 -8  9.0 0.9 0.0  1.15 "
             + "--insertbc " + " 50 -8  2.0 1.0 0.0  1.15  "
